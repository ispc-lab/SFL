...
class MixedDataset(Dataset):
    ...
    def _preprocess_structures(self):
        ...
        for pdb_path in tqdm(pdb_path_list, desc='Structures'):
            # pdb_path = pdb_path.split('processed_data/')[1]
            ...
            from BaselineModel.datasets import atom3d
            atom3d_info = atom3d.bp_to_df(atom3d.read_any(pdb_path))
            ...
            structures[pdbcode] = (data, seq_map, atom3d_info, pdb_path)
            # structures[pdbcode]['atom3d'] = atom3d_info
            # structures[pdbcode]['pdb_path'] = pdb_path

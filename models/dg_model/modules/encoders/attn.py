...
from ..common.geometry import global_to_local, local_to_global, normalize_vector, construct_3d_basis, angstrom_to_nm
from ..common.layers import mask_zero, LayerNorm
from ..protein.constants import BBHeavyAtom
...
class GAEncoder(nn.Module):
    ...
    def __init__(self, node_feat_dim=128, pair_feat_dim=64, num_layers=3, ga_block_opt={}):

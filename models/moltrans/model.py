...
class Moltrans(nn.Sequential):
    ...
    def __init__(self):
        ...
        self.decoder = nn.Linear(self.flatten_dim, 512)
          
    def forward(self, batch):
        d, d_mask, p, p_mask = batch['d_v'], batch['input_mask_d'], batch['p_v'], batch['input_mask_p']
        ...
        i_v = i.view(d_encoded_layers.shape[0], -1, self.max_d, self.max_p) 
        ...
        f = f.view(d_encoded_layers.shape[0], -1)
